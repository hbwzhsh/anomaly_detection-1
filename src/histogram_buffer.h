...
struct HofMbhBuffer
{
    ...
    void CreatePatchDescriptorPlaceholder(DescInfo& hogInfo, DescInfo& hofInfo, DescInfo& mbhInfo, DescInfo& hoaInfo)
	{
	...
	{
        CreatePatchDescriptorPlaceholder(hogInfo, hofInfo, mbhInfo, hoaInfo);
	}
